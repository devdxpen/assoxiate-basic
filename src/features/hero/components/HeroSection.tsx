...
export function HeroSection() {
  ...
  return (
    <section className="relative min-h-screen overflow-hidden bg-gradient-to-r from-gray-950 to-gray-700 text-white flex items-center pt-28 pb-8 mb-20 lg:mb-28">
