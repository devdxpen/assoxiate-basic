...
import { UserCheck, Sparkles, ShieldCheck, TrendingUp, Globe, MessageSquare } from "lucide-react";

const features = [
	{
		icon: <UserCheck className="size-7" />,
		title: "Verified Professionals",
		description: "Connect with verified active experts and business professionals.",
	...
	// Row 2
	{
		...
		description: "Track your profile views, connection requests, and job post performance stats.",
	...
	},
	{
		...
		description: "Expand your reach and collaborate with professionals from all around the world.",
	...
	},
	{
		...
		title: "Seamless Chat",
		description: "Communicate directly with connections and peers with built-in instant messaging.",
	...
	return (
		<AnimatedSection id="solutions" className="relative overflow-hidden py-20 lg:py-28">
			<div className="container-custom">
				<Heading align="start" as="h2" paragraph="Why choose us?" className="mb-4" />
				<p className="text-lg mb-8">
					Experience the future of professional networking with our innovative features.
				</p>
