		...
		content: (
			<div>
				<div className="mb-4 flex items-center gap-3">
					...
					<h4 className="h5">Create Your Profile</h4>
				</div>
				<p className="mb-6">
					Sign up and build your professional profile in minutes. Showcase your skills, experience,
					and portfolio to stand out in the network.
				</p>
		...
		content: (
			<div>
				<div className="mb-4 flex items-center gap-3">
					...
					<h4 className="h5">Connect & Collaborate</h4>
				</div>
				<p className="mb-6">
					Reach out to professionals, schedule meetings, and start collaborating on projects with
					seamless built-in communication tools.
				</p>
		...
		content: (
			<div>
				<div className="mb-4 flex items-center gap-3">
					...
					<h4 className="h5">Grow Your Career</h4>
				</div>
				<p className="mb-6">
					Track your progress, gather endorsements, and accelerate your professional growth with
					data-driven insights and analytics.
				</p>
				<div className="rounded-xl border border-gray-100 bg-gray-50 p-5">
					<div className="mb-4 flex items-center justify-between">
						<span className="text-base text-gray-700">Profile Visibility</span>
