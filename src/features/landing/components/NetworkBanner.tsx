...
import { User, Building2, Package, Wrench, Briefcase, Link2 } from "lucide-react";
...
const CircleNode = forwardRef<HTMLDivElement, NodeProps>(({ className, children, label }, ref) => {
	return (
				...
				<div className="grid grid-cols-1 gap-12 lg:grid-cols-2 lg:gap-16 items-center">
					...
					<div>
						...
						<p className="text-gray-500 max-w-md">
							AssoXiate connects every piece of your professional ecosystem. From companies and
							services to jobs and products — everything links back to you.
						</p>
					</div>
