...
const WhyChooseUsSection = dynamic(
  () =>
    import("@/features/landing/components/WhyChooseUsSection").then(
...
const NetworkBanner = dynamic(
  () =>
    import("@/features/landing/components/NetworkBanner").then(
      (m) => m.NetworkBanner,
    ),
  { ssr: false, loading: () => <SectionSkeleton /> },
);
...
const JobsSection = dynamic(
  () =>
    import("@/features/landing/components/JobsSection").then(
      (m) => m.JobsSection,
    ),
  { ssr: false, loading: () => <SectionSkeleton /> },
);
...
const ArticlesSection = dynamic(
  () =>
    import("@/features/landing/components/ArticlesSection").then(
      (m) => m.ArticlesSection,
    ),
  { ssr: false, loading: () => <SectionSkeleton /> },
);
...
const TestimonialsSection = dynamic(
  () =>
    import("@/features/landing/components/TestimonialsSection").then(
...
const CTASection = dynamic(
  () =>
    import("@/features/landing/components/CTASection").then(
      (m) => m.CTASection,
    ),
