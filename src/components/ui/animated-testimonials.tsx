		...
		<div className={cn("", className)}>
			<div className="relative grid grid-cols-1 md:grid-cols-2 gap-20">
				...
				<div className="flex justify-between flex-col py-4">
					...
					>
						<h3 className="h5 text-white">{testimonials[active].name}</h3>
					...
					<div className="flex gap-4 pt-12 md:pt-0">
						<Button onClick={handlePrev} size="icon-lg" variant="default" className="mt-8">
							<IconArrowLeft className="size-4" strokeWidth={2} />
						</Button>
						<Button onClick={handleNext} size="icon-lg" variant="default" className="mt-8 ">
