...
const defaultTestimonials: Testimonial[] = [
	{
		id: 1,
		quote:
			"A rare talent who bridges the gap between aesthetics and functionality with remarkable precision.",
		name: "Sarah Chen",
...
export function TestimonialsSplit({ testimonials = defaultTestimonials }: TestimonialsSplitProps) {
				...
				<div className="space-y-8">
					...
					<AnimatePresence mode="wait">
						<motion.div
							...
							className="inline-flex items-center gap-2 text-sm tracking-[0.2em] uppercase text-gray-400"
						>
					...
					<div className="relative overflow-hidden">
						<AnimatePresence mode="wait">
							<motion.blockquote
								...
								className="h3 text-white font-light"
							>
								{active.quote}
							</motion.blockquote>
						</AnimatePresence>
